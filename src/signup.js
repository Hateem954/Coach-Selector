...
//         try {
//             // Make API call to sign up the user using axios
//             const response = await axios.post('http://10.0.2.2:8000/api/signup/', signUpData); // Include signUpData here

//             console.log('Response:', response.data);

//             if (response.status === 200) {
//                 Alert.alert('Success', 'Account created successfully');
//                 navigation.navigate('otppopup'); // Navigate to Profile after signup
//             } else {
//                 Alert.alert('Error', response.data.message || 'Failed to sign up');
//             }
//         } catch (error) {
//             console.error('Error signing up:', error.response ? error.response.data : error); // Log the actual error
...
//                 disabled={!isFormValid() || loading} // Disable if form invalid or during loading
//             >
